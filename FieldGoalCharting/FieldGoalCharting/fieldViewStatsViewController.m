...
- (void)dealloc {
    ...
    [_25LeftLabel release];
    [_20LeftView release];
    [_20MiddleView release];
    [_20RightView release];
    [_25LeftView release];
    [_25MiddleView release];
    [_25RightView release];
    [_30LeftView release];
    [_30MiddleView release];
    [_30RightView release];
    [_35LeftView release];
    [_35MiddleView release];
    [_35RightView release];
    [_40LeftView release];
    [_40MiddleView release];
    [_40RightView release];
    [_45LeftView release];
    [_45MiddleView release];
    [_45RightView release];
    [_50LeftView release];
    [_50MiddleView release];
    [_50RightView release];
    [_55LeftView release];
    [_55MiddleView release];
    [_55RightView release];
    [_56LeftView release];
    [_56MiddleView release];
    [_56RightView release];
